        ...
        <form method="post" id="contactForm">
            <div class="form-group">
                <label for="name" class="control-label">
                    <input type="text" id="name" name="name" class="form-control" required placeholder="Name" maxlength="50"/>
                </label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="phone" class="control-label">
                    <input type="tel" id="phone" name="phone" class="form-control" placeholder="Phone number" pattern="^[\d\s\-\(\)\+]*$"/>
                </label>
            </div>
            <div class="form-group">
                <label for="message" class="control-label">
                    <textarea name="message" id="message" placeholder="Enter your message here" required class="message"></textarea>
                </label>
            </div>
